...
QAndroidPlayerControl::QAndroidPlayerControl(QAndroidPlayerSession *session, QObject *parent)
...
QAndroidPlayerControl::~QAndroidPlayerControl()
{
    if (m_fifoFd[0] >= 0) {
        ::close(m_fifoFd[0]);
        ::close(m_fifoFd[1]);
...
qint64 QAndroidPlayerControl::position() const
{
    return m_seekToStartPending ? 0 : m_session->position();
}

qint64 QAndroidPlayerControl::duration() const
{
    return m_session->duration();
}

QMediaPlayer::State QAndroidPlayerControl::state() const
{
    return m_state;
}

QMediaPlayer::MediaStatus QAndroidPlayerControl::mediaStatus() const
{
    return m_mediaStatus;
}

int QAndroidPlayerControl::bufferStatus() const
{
...
int QAndroidPlayerControl::volume() const
{
    return m_session->volume();
}

bool QAndroidPlayerControl::isMuted() const
{
    return m_session->isMuted();
}

bool QAndroidPlayerControl::isSeekable() const
{
    return m_session->isSeekable();
}

QMediaTimeRange QAndroidPlayerControl::availablePlaybackRanges() const
{
...
qreal QAndroidPlayerControl::playbackRate() const
{
    return m_session->playbackRate();
}

void QAndroidPlayerControl::setPlaybackRate(qreal rate)
{
    m_session->setPlaybackRate(rate);
}

void QAndroidPlayerControl::setPosition(qint64 pos)
{
...
void QAndroidPlayerControl::play()
{
    playOrPause(QMediaPlayer::PlayingState);
}

void QAndroidPlayerControl::pause()
{
    playOrPause(QMediaPlayer::PausedState);
}

void QAndroidPlayerControl::playOrPause(QMediaPlayer::State newState)
{
...
void QAndroidPlayerControl::stop()
{
...
void QAndroidPlayerControl::setVolume(int volume)
{
    m_session->setVolume(volume);
}

void QAndroidPlayerControl::setMuted(bool muted)
{
    m_session->setMuted(muted);
}

QMediaContent QAndroidPlayerControl::media() const
{
    return m_currentResource;
}

const QIODevice *QAndroidPlayerControl::mediaStream() const
{
    return m_stream;
}

void QAndroidPlayerControl::setMedia(const QMediaContent &content, QIODevice *stream)
{
    QMediaPlayer::State oldState = m_state;
    m_state = QMediaPlayer::StoppedState;    
    m_session->stop();
...
void QAndroidPlayerControl::setVideoOutput(QObject *output)
{
    Q_UNUSED(output);
}

bool QAndroidPlayerControl::isAudioAvailable() const
{
    return m_session->isAudioAvailable();
}

bool QAndroidPlayerControl::isVideoAvailable() const
{
    return m_session->isVideoAvailable();
}

void QAndroidPlayerControl::updateState(QMediaPlayer::State state)
{
...
void QAndroidPlayerControl::processEOS()
{
    m_mediaStatus = QMediaPlayer::EndOfMedia;
    stop();
    emit mediaStatusChanged(m_mediaStatus);
...
void QAndroidPlayerControl::setBufferProgress(int progress)
{
...
void QAndroidPlayerControl::writeFifo()
{
    if (m_fifoCanWrite) {
...
void QAndroidPlayerControl::fifoReadyWrite(int socket)
{
...
bool QAndroidPlayerControl::openFifo()
{
...
void QAndroidPlayerControl::closeFifo()
{
    if (m_fifoFd[0] >= 0) {
...
void QAndroidPlayerControl::handleInvalidMedia()
{
