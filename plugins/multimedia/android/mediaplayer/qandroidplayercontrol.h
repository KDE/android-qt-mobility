...
#ifndef QANDROIDPLAYERCONTROL_H
#define QANDROIDPLAYERCONTROL_H
...
class QAndroidPlayerControl : public QMediaPlayerControl
{
    Q_OBJECT

public:
    QAndroidPlayerControl(QAndroidPlayerSession *session, QObject *parent = 0);
    ~QAndroidPlayerControl();
