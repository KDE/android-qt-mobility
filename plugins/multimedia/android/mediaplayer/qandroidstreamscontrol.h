...
class QAndroidStreamsControl : public QMediaStreamsControl
{
    Q_OBJECT
public:
    QAndroidStreamsControl(QAndroidPlayerSession *session, QObject *parent);
    virtual ~QAndroidStreamsControl();
